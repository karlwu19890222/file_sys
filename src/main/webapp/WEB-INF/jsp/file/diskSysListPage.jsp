		...
		<script type="text/javascript">
			...
			$(function() {
				treeSys = $('#treeSys').tree({
					url: '${path }/file/disk/sys/findGrandFatherTrees?type=company',
					animate: true,
					lines: true,
			...
			function insertFun() {
				parent.$.modalDialog({
					...
					width: 550,
					height: 500,
					href: '${path }/file/disk/sys/toInsertPage?type=company',
					buttons: [{
						text: '完成',
						handler: function() {
			...
			function moveAttachmentFun() {
				...
				if(row) {
					parent.$.modalDialog({
						...
						height:300,
						iconCls: 'fa fa-plus-square',
						href: '${path }/file/disk/sys/toMoveFilePage?id=' + row.id+"&type=company&objectId="+row.objectId,
						buttons: [{
							text: '提交',
							handler: function() {
								parent.$.modalDialog.openner_dataGrid = dataGridFile;
